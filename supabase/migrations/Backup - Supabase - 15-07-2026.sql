...
BEGIN
  ...
  SELECT COUNT(*) + 1 INTO seq_num FROM manager_protocols 
  WHERE TO_CHAR(created_at, 'YYYY') = year_part;
  proto := 'PROT-' || year_part || '-' || LPAD(seq_num::TEXT, 6, '0');
  RETURN proto;
END;
$$;
...
BEGIN
  year_part := TO_CHAR(NOW(), 'YYYY');
  SELECT COUNT(*) + 1 INTO seq_num FROM manager_tickets 
  WHERE TO_CHAR(created_at, 'YYYY') = year_part;
  RETURN 'TICK-' || year_part || '-' || LPAD(seq_num::TEXT, 6, '0');
END;
$$;
...
COMMENT ON COLUMN "public"."employees"."termination_date" IS 'Data exata em que o colaborador foi desligado da empresa, usado para analytics de turnover';
...
CREATE OR REPLACE FUNCTION "public"."get_my_active_sessions"() RETURNS TABLE("session_id" "uuid", "created_at" timestamp with time zone, "last_sign_in_at" timestamp with time zone, "ip_address" "inet", "user_agent" "text")
    LANGUAGE "plpgsql" SECURITY DEFINER
    AS $$
BEGIN
  RETURN QUERY
  SELECT 
    s.id AS session_id, 
    s.created_at, 
    s.updated_at AS last_sign_in_at, 
    s.ip AS ip_address, 
    s.user_agent
...
ALTER FUNCTION "public"."get_my_active_sessions"() OWNER TO "postgres";
...
CREATE OR REPLACE FUNCTION "public"."is_manager_protocol_recipient"("p_id" "uuid") RETURNS boolean
    LANGUAGE "sql" SECURITY DEFINER
    SET "search_path" TO 'public'
    AS $$
  SELECT EXISTS (
    SELECT 1 FROM protocol_recipients
    WHERE protocol_id = p_id AND recipient_id = auth.uid()
  );
$$;


ALTER FUNCTION "public"."is_manager_protocol_recipient"("p_id" "uuid") OWNER TO "postgres";


CREATE OR REPLACE FUNCTION "public"."is_manager_protocol_sender"("p_id" "uuid") RETURNS boolean
    LANGUAGE "sql" SECURITY DEFINER
    SET "search_path" TO 'public'
    AS $$
  SELECT EXISTS (
    SELECT 1 FROM manager_protocols
    WHERE id = p_id AND sender_id = auth.uid()
  );
$$;


ALTER FUNCTION "public"."is_manager_protocol_sender"("p_id" "uuid") OWNER TO "postgres";


CREATE OR REPLACE FUNCTION "public"."is_protocol_recipient"("p_protocol_id" "uuid") RETURNS boolean
...
ALTER FUNCTION "public"."is_protocol_recipient"("p_protocol_id" "uuid") OWNER TO "postgres";


CREATE OR REPLACE FUNCTION "public"."is_protocol_sender"("p_protocol_id" "uuid") RETURNS boolean
    LANGUAGE "sql" STABLE SECURITY DEFINER
    SET "search_path" TO 'public'
    AS $$
  SELECT EXISTS (
...
ALTER FUNCTION "public"."is_protocol_sender"("p_protocol_id" "uuid") OWNER TO "postgres";
...
CREATE OR REPLACE FUNCTION "public"."restore_employee"("employee_id" "uuid") RETURNS "void"
    LANGUAGE "plpgsql" SECURITY DEFINER
    AS $$
BEGIN
...
ALTER FUNCTION "public"."restore_employee"("employee_id" "uuid") OWNER TO "postgres";


COMMENT ON FUNCTION "public"."restore_employee"("employee_id" "uuid") IS 'Restaura um colaborador excluído logicamente (soft delete), limpando deleted_at e reativando o status.';
...
ALTER TABLE "public"."manager_protocols" OWNER TO "postgres";


CREATE SEQUENCE IF NOT EXISTS "public"."manager_protocols_seq"
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
ALTER SEQUENCE "public"."manager_protocols_seq" OWNER TO "postgres";
...
CREATE TABLE IF NOT EXISTS "public"."manager_tickets" (
    ...
    "assigned_to" "text" DEFAULT 'RH Estratégico'::"text" NOT NULL,
...
ALTER TABLE "public"."manager_tickets" OWNER TO "postgres";


CREATE SEQUENCE IF NOT EXISTS "public"."manager_tickets_seq"
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
ALTER SEQUENCE "public"."manager_tickets_seq" OWNER TO "postgres";
...
ALTER TABLE "public"."protocol_recipients" OWNER TO "postgres";
...
ALTER TABLE "public"."protocol_replies" OWNER TO "postgres";
...
CREATE TABLE IF NOT EXISTS "public"."settings" (
    ...
    "login_title" "text",
    "login_subtitle" "text",
    "employee_custom_fields_config" "jsonb" DEFAULT '[]'::"jsonb",
    "career_page_banner" "text",
    "career_page_description" "text",
...
COMMENT ON COLUMN "public"."settings"."webhook_url" IS 'URL do webhook do ERP ou sistema contábil para receber notificações quando uma folha de pagamento é fechada.';
...
ALTER TABLE ONLY "public"."manager_protocols"
    ADD CONSTRAINT "manager_protocols_pkey" PRIMARY KEY ("id");



ALTER TABLE ONLY "public"."manager_protocols"
    ADD CONSTRAINT "manager_protocols_protocol_number_key" UNIQUE ("protocol_number");



ALTER TABLE ONLY "public"."manager_tickets"
    ADD CONSTRAINT "manager_tickets_pkey" PRIMARY KEY ("id");



ALTER TABLE ONLY "public"."manager_tickets"
    ADD CONSTRAINT "manager_tickets_ticket_number_key" UNIQUE ("ticket_number");
...
ALTER TABLE ONLY "public"."protocol_recipients"
    ADD CONSTRAINT "protocol_recipients_pkey" PRIMARY KEY ("id");



ALTER TABLE ONLY "public"."protocol_replies"
    ADD CONSTRAINT "protocol_replies_pkey" PRIMARY KEY ("id");
...
ALTER TABLE ONLY "public"."manager_protocols"
    ADD CONSTRAINT "manager_protocols_sender_id_fkey" FOREIGN KEY ("sender_id") REFERENCES "auth"."users"("id");



ALTER TABLE ONLY "public"."manager_protocols"
    ADD CONSTRAINT "manager_protocols_user_id_fkey" FOREIGN KEY ("user_id") REFERENCES "auth"."users"("id");



ALTER TABLE ONLY "public"."manager_tickets"
    ADD CONSTRAINT "manager_tickets_requester_id_fkey" FOREIGN KEY ("requester_id") REFERENCES "auth"."users"("id");
...
ALTER TABLE ONLY "public"."protocol_recipients"
    ADD CONSTRAINT "protocol_recipients_protocol_id_fkey" FOREIGN KEY ("protocol_id") REFERENCES "public"."manager_protocols"("id") ON DELETE CASCADE;



ALTER TABLE ONLY "public"."protocol_recipients"
    ADD CONSTRAINT "protocol_recipients_recipient_id_fkey" FOREIGN KEY ("recipient_id") REFERENCES "auth"."users"("id");



ALTER TABLE ONLY "public"."protocol_replies"
    ADD CONSTRAINT "protocol_replies_protocol_id_fkey" FOREIGN KEY ("protocol_id") REFERENCES "public"."manager_protocols"("id") ON DELETE CASCADE;



ALTER TABLE ONLY "public"."protocol_replies"
    ADD CONSTRAINT "protocol_replies_sender_id_fkey" FOREIGN KEY ("sender_id") REFERENCES "auth"."users"("id");
...
CREATE POLICY "Abrir chamado" ON "public"."manager_tickets" FOR INSERT TO "authenticated" WITH CHECK (("requester_id" = "auth"."uid"()));
...
CREATE POLICY "Admins can view all employees including deleted" ON "public"."employees" FOR SELECT TO "authenticated" USING ((EXISTS ( SELECT 1
...
CREATE POLICY "Atualizacao de perfis (proprio ou admin)" ON "public"."profiles" FOR UPDATE USING ((("auth"."uid"() = "id") OR "public"."is_admin"()));



CREATE POLICY "Atualizar chamado" ON "public"."manager_tickets" FOR UPDATE TO "authenticated" USING (("requester_id" = "auth"."uid"()));
...
CREATE POLICY "Authenticated users can view active employees" ON "public"."employees" FOR SELECT TO "authenticated" USING (("deleted_at" IS NULL));



CREATE POLICY "Permitir leitura de profiles para usuarios logados" ON "public"."profiles" FOR SELECT USING (("auth"."uid"() IS NOT NULL));
...
CREATE POLICY "Ver meus chamados" ON "public"."manager_tickets" FOR SELECT TO "authenticated" USING (("requester_id" = "auth"."uid"()));
...
CREATE POLICY "mp_insert" ON "public"."manager_protocols" FOR INSERT TO "authenticated" WITH CHECK (("sender_id" = "auth"."uid"()));



CREATE POLICY "mp_select" ON "public"."manager_protocols" FOR SELECT TO "authenticated" USING ((("sender_id" = "auth"."uid"()) OR "public"."is_protocol_recipient"("id")));
...
CREATE POLICY "pr_insert" ON "public"."protocol_recipients" FOR INSERT TO "authenticated" WITH CHECK ("public"."is_protocol_sender"("protocol_id"));



CREATE POLICY "pr_select" ON "public"."protocol_recipients" FOR SELECT TO "authenticated" USING ((("recipient_id" = "auth"."uid"()) OR "public"."is_protocol_sender"("protocol_id")));



CREATE POLICY "pr_update" ON "public"."protocol_recipients" FOR UPDATE TO "authenticated" USING (("recipient_id" = "auth"."uid"()));
...
CREATE POLICY "pry_insert" ON "public"."protocol_replies" FOR INSERT TO "authenticated" WITH CHECK (("sender_id" = "auth"."uid"()));



CREATE POLICY "pry_select" ON "public"."protocol_replies" FOR SELECT TO "authenticated" USING (("public"."is_protocol_sender"("protocol_id") OR "public"."is_protocol_recipient"("protocol_id")));
...
CREATE POLICY "ticket_insert" ON "public"."manager_tickets" FOR INSERT TO "authenticated" WITH CHECK (("requester_id" = "auth"."uid"()));



CREATE POLICY "ticket_select" ON "public"."manager_tickets" FOR SELECT TO "authenticated" USING (("requester_id" = "auth"."uid"()));



CREATE POLICY "ticket_update" ON "public"."manager_tickets" FOR UPDATE TO "authenticated" USING (("requester_id" = "auth"."uid"()));
...
CREATE POLICY "tickets_insert" ON "public"."manager_tickets" FOR INSERT WITH CHECK (("requester_id" = "auth"."uid"()));



CREATE POLICY "tickets_select" ON "public"."manager_tickets" FOR SELECT USING (("requester_id" = "auth"."uid"()));
...
GRANT ALL ON FUNCTION "public"."get_my_active_sessions"() TO "anon";
GRANT ALL ON FUNCTION "public"."get_my_active_sessions"() TO "authenticated";
GRANT ALL ON FUNCTION "public"."get_my_active_sessions"() TO "service_role";
...
GRANT ALL ON FUNCTION "public"."is_manager_protocol_recipient"("p_id" "uuid") TO "anon";
GRANT ALL ON FUNCTION "public"."is_manager_protocol_recipient"("p_id" "uuid") TO "authenticated";
GRANT ALL ON FUNCTION "public"."is_manager_protocol_recipient"("p_id" "uuid") TO "service_role";



GRANT ALL ON FUNCTION "public"."is_manager_protocol_sender"("p_id" "uuid") TO "anon";
GRANT ALL ON FUNCTION "public"."is_manager_protocol_sender"("p_id" "uuid") TO "authenticated";
GRANT ALL ON FUNCTION "public"."is_manager_protocol_sender"("p_id" "uuid") TO "service_role";



GRANT ALL ON FUNCTION "public"."is_protocol_recipient"("p_protocol_id" "uuid") TO "anon";
GRANT ALL ON FUNCTION "public"."is_protocol_recipient"("p_protocol_id" "uuid") TO "authenticated";
GRANT ALL ON FUNCTION "public"."is_protocol_recipient"("p_protocol_id" "uuid") TO "service_role";



GRANT ALL ON FUNCTION "public"."is_protocol_sender"("p_protocol_id" "uuid") TO "anon";
GRANT ALL ON FUNCTION "public"."is_protocol_sender"("p_protocol_id" "uuid") TO "authenticated";
GRANT ALL ON FUNCTION "public"."is_protocol_sender"("p_protocol_id" "uuid") TO "service_role";
...
GRANT ALL ON FUNCTION "public"."restore_employee"("employee_id" "uuid") TO "anon";
GRANT ALL ON FUNCTION "public"."restore_employee"("employee_id" "uuid") TO "authenticated";
GRANT ALL ON FUNCTION "public"."restore_employee"("employee_id" "uuid") TO "service_role";
...
GRANT ALL ON TABLE "public"."manager_protocols" TO "anon";
GRANT ALL ON TABLE "public"."manager_protocols" TO "authenticated";
GRANT ALL ON TABLE "public"."manager_protocols" TO "service_role";



GRANT ALL ON SEQUENCE "public"."manager_protocols_seq" TO "anon";
GRANT ALL ON SEQUENCE "public"."manager_protocols_seq" TO "authenticated";
GRANT ALL ON SEQUENCE "public"."manager_protocols_seq" TO "service_role";



GRANT ALL ON TABLE "public"."manager_tickets" TO "anon";
GRANT ALL ON TABLE "public"."manager_tickets" TO "authenticated";
GRANT ALL ON TABLE "public"."manager_tickets" TO "service_role";



GRANT ALL ON SEQUENCE "public"."manager_tickets_seq" TO "anon";
GRANT ALL ON SEQUENCE "public"."manager_tickets_seq" TO "authenticated";
GRANT ALL ON SEQUENCE "public"."manager_tickets_seq" TO "service_role";
...
GRANT ALL ON TABLE "public"."protocol_recipients" TO "anon";
GRANT ALL ON TABLE "public"."protocol_recipients" TO "authenticated";
GRANT ALL ON TABLE "public"."protocol_recipients" TO "service_role";



GRANT ALL ON TABLE "public"."protocol_replies" TO "anon";
GRANT ALL ON TABLE "public"."protocol_replies" TO "authenticated";
GRANT ALL ON TABLE "public"."protocol_replies" TO "service_role";
