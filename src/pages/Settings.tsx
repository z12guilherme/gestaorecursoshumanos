    ...
    try {
      ...
      if (USE_MOCK) {
        if (activeTab === "profile") {
          toast({
            title: "Perfil salvo",
            description: "Suas informações foram atualizadas (Modo Demo).",
          });
        } else if (
          ["company", "notifications", "appearance", "custom_fields", "career_page"].includes(
            activeTab
          )
        ) {
          const payload = {
            ...
            webhook_url: companySettings.webhook_url,
          };
          mockDatabase.set("settings", payload);
          toast({
            title: "Configurações salvas",
            description: "As alterações da empresa foram aplicadas (Modo Demo).",
          });
        }
        return;
      }
      ...
      if (activeTab === "profile") {
        ...
        toast({
          title: "Configurações salvas",
          description: "As alterações da empresa foram aplicadas.",
        });
      }
    } catch (error: any) {
    ...
    try {
      if (USE_MOCK) {
        setUserProfiles([
          ...
          {
            id: "102",
            full_name: "Ana do Marketing",
            email: "ana.mkt@empresa.com",
            role: "manager",
            display_role: "Coordenadora de Marketing",
          },
          {
            id: "103",
            full_name: "João do Financeiro",
            email: "joao.fin@empresa.com",
            role: "employee",
            display_role: "Analista Financeiro",
          },
        ]);
        return;
      }
  ...
  const handleRoleChange = async (userId: string, newRole: string) => {
    ...
    try {
      ...
      toast({
        ...
        description: `Role alterada para "${newRole}" com sucesso.`,
      });
    } catch (err) {
          ...
          {activeTab === "company" && (
            <Card>
              <CardHeader>
                ...
                <CardDescription>
                  Informações utilizadas em cabeçalhos de relatórios.
                </CardDescription>
              </CardHeader>
              <CardContent className="space-y-6">
                <div className="flex flex-col items-center sm:flex-row gap-6">
                ...
                <div className="grid gap-2">
                  ...
                  <Input
                    ...
                    onChange={(e) =>
                      setCompanySettings({ ...companySettings, cnpj: e.target.value })
                    }
            ...
            <Card>
              <CardHeader className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
                <div>
                  ...
                  <CardDescription>
                    Crie campos adicionais para a ficha de cadastro (ex: Ramal, Placa do Carro,
                    Tamanho da Bota).
                  </CardDescription>
                </div>
                <Button
              ...
              <CardContent className="space-y-4">
                {companySettings.employee_custom_fields_config.length === 0 ? (
                  ...
                  companySettings.employee_custom_fields_config.map((field) => (
                    <div
                      key={field.id}
                      className="flex flex-col sm:flex-row items-end sm:items-center gap-4 p-4 border rounded-lg bg-secondary/20 transition-all hover:bg-secondary/40"
                    >
          ...
          {activeTab === "career_page" && (
            <Card>
              <CardHeader>
                ...
                <CardDescription>
                  Personalize a página pública onde os candidatos visualizam suas vagas abertas.
                </CardDescription>
              </CardHeader>
              <CardContent className="space-y-6">
                <div className="grid gap-2">
                  ...
                  <div className="flex items-center gap-4">
                    {companySettings.career_page_banner && (
                      <img
                        src={companySettings.career_page_banner}
                        alt="Banner"
                    ...
                    <Input
                      type="file"
                      accept="image/*"
                      onChange={handleCareerBannerUpload}
                      className="w-full"
                    />
                  </div>
                ...
                <div className="grid gap-2">
                  ...
                  <Textarea
                    ...
                    onChange={(e) =>
                      setCompanySettings((prev) => ({
                        ...prev,
                        career_page_description: e.target.value,
                      }))
                    }
                ...
                <div className="grid gap-4 sm:grid-cols-2">
                  ...
                  <div className="grid gap-2 sm:col-span-2">
                    <Label className="flex items-center gap-2">
                      <Globe className="h-4 w-4 text-muted-foreground" /> Site Oficial
                    </Label>
                    <Input
              ...
              <CardContent className="space-y-4">
                <div className="flex items-center justify-between rounded-lg border p-4">
                  ...
                  <Switch
                    ...
                    onCheckedChange={(c) =>
                      setCompanySettings({ ...companySettings, notifications_enabled: c })
                    }
                  />
                </div>
              </CardContent>
          ...
          {activeTab === "appearance" && (
            <Card>
              <CardHeader>
                ...
                <CardDescription>
                  Personalize a interface do sistema e a tela de entrada.
                </CardDescription>
              </CardHeader>
              <CardContent>
                  ...
                  <div className="grid gap-4">
                    <div className="grid gap-2">
                      ...
                      <div className="flex items-center gap-4">
                        {companySettings.login_background_url && (
                          <img
                            src={companySettings.login_background_url}
                            alt="Fundo de Login"
                            className="w-32 h-20 object-cover rounded-md border"
                          />
                        )}
                        <Input
                          ...
                          type="file"
                          accept="image/*"
                          onChange={handleCompanyBackgroundUpload}
                          className="w-full"
                        />
                      </div>
                    </div>
                    <div className="grid gap-2">
                      ...
                      <Input
                        ...
                        onChange={(e) =>
                          setCompanySettings({ ...companySettings, login_title: e.target.value })
                        }
                    ...
                    <div className="grid gap-2">
                      ...
                      <Textarea
                        ...
                        onChange={(e) =>
                          setCompanySettings({ ...companySettings, login_subtitle: e.target.value })
                        }
                ...
                <p className="text-xs text-muted-foreground mt-4">
                  * O tema é controlado atualmente pelo botão na barra lateral. Esta configuração
                ...
                <div className="flex gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-blue-700 dark:text-blue-300 mt-1">
                      Por questões de segurança, para criar um novo usuário no sistema real você
                      deve usar o painel do{" "}
                      <strong>Supabase &gt; Authentication &gt; Add User</strong>.<br />
                      <br />
                      Após o usuário ser criado lá (ou fazer login pela primeira vez), ele aparecerá
                      automaticamente na lista abaixo. Então, você poderá definir livremente se o
                      acesso dele é de <strong>Admin</strong>, <strong>Gestor</strong> ou{" "}
                  ...
                  <div className="flex gap-3">
                    ...
                    <div>
                      ...
                      <p className="text-xs text-amber-700 dark:text-amber-300 mt-1">
                        O envio de convites requer a <strong>Service Role Key</strong> do Supabase
                        configurada no backend. A alteração de roles funciona diretamente pela
            ...
            <div className="space-y-6">
              <Card>
                <CardHeader>
                  ...
                  <CardDescription>
                    Configure o webhook para notificar automaticamente o sistema ERP ou contábil ao
                    fechar a folha de pagamento.
                  </CardDescription>
                </CardHeader>
                <CardContent className="space-y-5">
                  <div className="space-y-2">
                    <Label htmlFor="webhook_url">URL do Webhook do ERP</Label>
                    <Input
                      id="webhook_url"
                      type="url"
                      placeholder="https://seu-erp.com/api/webhook/folha"
                      value={companySettings.webhook_url}
                      onChange={(e) =>
                        setCompanySettings((prev) => ({ ...prev, webhook_url: e.target.value }))
                      }
                    />
                    <p className="text-xs text-muted-foreground">
                      Ao clicar em <strong>Fechar Folha &amp; Notificar ERP</strong> na página de
                      Salários, um HTTP POST com o payload da folha será enviado para este URL.
                    </p>
                  </div>
                  ...
                  <div className="rounded-lg border border-blue-200 bg-blue-50 dark:border-blue-800 dark:bg-blue-950/30 p-4">
                    <div className="flex gap-3">
                      ...
                      <div>
                        ...
                        <ul className="text-xs text-blue-700 dark:text-blue-300 mt-1 space-y-1 list-disc ml-3">
                          <li>
                            A Edge Function <code>payroll-webhook</code> envia um JSON padronizado
                            com competência, empresa e lista de colaboradores com valores
                            calculados.
                          </li>
                          <li>
                            O payload inclui: nome, cargo, departamento, CPF/PIS, chave PIX, salário
                            base, adicionais, descontos, INSS e líquido.
                          </li>
                          <li>
                            Todos os fechamentos são registrados nos Logs de Auditoria do sistema.
                          </li>
                        </ul>
                      </div>
                    </div>
                    ...
                    <div className="rounded-lg border border-amber-200 bg-amber-50 dark:border-amber-800 dark:bg-amber-950/30 p-4">
                      <div className="flex gap-3">
                        ...
                        <div>
                          ...
                          <p className="text-xs text-amber-700 dark:text-amber-300 mt-1">
                            Para ativar o webhook, certifique-se de que a Edge Function foi
                            publicada no Supabase:
                          </p>
                          <code className="block mt-2 text-xs bg-amber-100 dark:bg-amber-900/50 rounded px-2 py-1 text-amber-800 dark:text-amber-200">
