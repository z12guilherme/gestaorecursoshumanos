...
const suggestedQuestions = [
  {
    icon: Users,
    text: 'Cadastre o funcionário "Marcos Guilherme", cargo "Desenvolvedor Pleno", no departamento "Tecnologia"',
  },
...
export default function AIAssistant() {
  ...
  const displayMessages =
    messages.length > 0
      ? messages.filter((m) => m.id !== "initial-menu")
      : [
          {
            id: "welcome",
            role: "assistant" as const,
            content:
              "Olá! Sou o assistente de IA do RH. Posso ajudar com análises de dados, relatórios, sugestões de desenvolvimento e muito mais. Como posso ajudar você hoje?",
            timestamp: new Date(),
          },
        ];
              ...
              <div className="flex items-center gap-4">
                ...
                <div>
                  ...
                  <p className="text-sm text-muted-foreground flex items-center gap-1">
                    ...
                    Online • <Zap className="h-3 w-3 text-amber-500 inline" /> Powered by Groq AI
                  </p>
                </div>
              </div>
              <Button
          ...
          <CardContent className="flex-1 flex flex-col p-0 bg-slate-50/50 dark:bg-slate-950/50 relative overflow-hidden">
            ...
            <div className="p-4 bg-background border-t border-border">
              ...
              <p className="text-xs text-center text-muted-foreground mt-2 flex items-center justify-center gap-1">
                ...
                Groq • llama-3.3-70b-versatile • A IA pode cometer erros. Verifique informações
                importantes.
              </p>
            </div>
          </CardContent>
